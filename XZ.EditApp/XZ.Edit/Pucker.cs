...
namespace XZ.Edit {
    ...
    public class Pucker {
        ...
        public Pucker(Parser parser) {
            ...
            //this.PuckerYAndLength = new SortedDictionary<int, int>();
        }
        ...
        Start:
            ...
            //System.Diagnostics.Debug.WriteLine("GetNextNode");
        ...
        public void RmovePuckerLeavings(LineString ls) {
            ...
            //PDictPuckerLeavings.Add(ls.ID, Tuple.Create(text, array));
