    ...
    public class Parser {
        ...
        public void AddText(string value) {
            if (this.pLanguageMode == null)
                throw new Exception("写入数据之前，请先设置语言");

            //this.PLineNum = new List<int>();
        ...
        //public List<int> PLineNum { get; set; }
        ...
        //public void ClearStartEndPostion(int y, int length) {
        //    this.pDraw.ClearStartEndPostion(y, length);
        //}
        ...
        public CPoint SetCurosrPosition(int x, int y, bool isClearSelectBg = true) {
            ...
            //this.pCursor.CousorPointForEdit.Y = this.pCursor.CousorPointForWord.Y * FontContainer.FontHeight;
            ...
            //this.pCursor.XForLeft = ssWord.LeftWidth;
        ...
        public ToolTipMessageEventArgs GetToolTipMessage(Point point, out Rectangle rect) {
            ...
            if (ssWord.LineIndex < 0)
                return null;
            //tipMessage.Point = new Point(ssWord.LineIndex, y);
