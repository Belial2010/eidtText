...
namespace XZ.Edit {
    public partial class EditTextBox : EventEdit, IEdit {
        ...
        [DefaultValue(typeof(Color), "173, 214, 255")]
        [Description("选中的背景颜色")]
        ...
        [DefaultValue(typeof(Color), "183, 181, 221")]
        [Description("折叠颜色")]
        ...
        [DefaultValue(typeof(Color), "246, 185, 77")]
        [Description("查找的背景颜色")]
        ...
        [DefaultValue(typeof(Color), "144, 156, 127")]
        [Description("查找的背景颜色")]
        ...
        public override string Text {
            ...
            set {
                ...
                //System.Diagnostics.Debug.WriteLine(this._contents.GetCount());
            }
        }
        ...
        //    pe.Graphics.FillRectangle(new SolidBrush(Color.White), pe.ClipRectangle);
        //}
