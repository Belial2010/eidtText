...
namespace XZ.Edit {
    public class KeyEvent {
        ...
        public KeyEvent(Parser parser) {
            ...
            //keyEvents[Keys.Delete] = new DeleteAction(parser);
            //keyEvents[Keys.Back] = new BackSpaceAction();
            keyEvents[Keys.Control | Keys.A] = new AllSelectAction(parser);
            //keyEvents[Keys.Control | Keys.X] = new CutAction();
            keyEvents[Keys.Control | Keys.C] = new CopyAction(parser);
            //keyEvents[Keys.Control | Keys.V] = new PasteAction();
            ...
            //keyEvents[Keys.Escape] = new NoneAction();
