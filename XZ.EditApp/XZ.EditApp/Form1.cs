    ...
    public partial class Form1 : Form {
        ...
        private void InitText() {
            ...
            if (File.Exists(path)) {
                ...
                sbStr.AppendLine("    /// Char and style");
                sbStr.AppendLine("    /// </summary>");
                sbStr.AppendLine("    struct Char");
                sbStr.AppendLine("    {");
                sbStr.AppendLine("        public char c;");
                sbStr.AppendLine("        public StyleIndex style;");
                sbStr.AppendLine("");
                sbStr.AppendLine("        public Char(char c)");
                sbStr.AppendLine("        {");
                sbStr.AppendLine("            this.c = c;");
                sbStr.AppendLine("            style = StyleIndex.None;");
                sbStr.AppendLine("        }");
                sbStr.AppendLine("    }");
                sbStr.AppendLine("");
            }
